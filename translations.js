    ...
    resources: {
        en: {
            translation: {
                ...
                "toggle-dealin-rate" : "Toggle dealin rate display<br><br>(Not output by Mortal, simple heuristics only)",
                ...
                "about-body-1":[
                    ...
                    ['<code>d</code>', 'Toggle dealin display<br>(Not output by Mortal, simple heuristics only)'],
        ...
        'zh-CN': {
            translation: {
                ...
                "toggle-dealin-rate" : "开关铳率条<br><br>（非 Mortal 输出，仅使用简单启发式算法）",
                "options-label": "选项",
                "options": "选项",
                "langLabel": "语言",
                "about": "关于",
                ...
                "about-body-1":[
                    ...
                    ['<code>h</code>', '开关别家手牌'],
                    ['<code>d</code>', '开关铳率条<br>（非 Mortal 输出，仅使用简单启发式算法）'],
